      ...
      <Card className='max-w-7xl rounded-md mx-auto bg-white shadow-md pt-5 mt-14'>
        ...
        <div className='p-6'>
            <div className='flex flex-col lg:flex-row lg:space-x-8'>
                <img src={selectedCourse.thumbnail} alt="Thumbnail" className='w-full lg:w-1/3 rounded-md mb-4 lg:mb-0' />
                <div>
                    ...
                    <div className='mt-1'>
                        <p className="text-2xl font-bold text-gray-800">₹{selectedCourse.price}</p>
        ...
        {
            courseLecture?.length==0 ? null : <div className='flex flex-col md:flex-row gap-10 justify-between p-6'>
                <div className='flex-1'>
                    <h1 className='text-xl font-bold text-gray-800'>Course Curriculum</h1>
                ...
                <div className='w-fu4 lg:w-1/3'>
                    <Card>
                        <CardContent className='p-4 flex flex-col'>
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum odio beatae sint. Fugiat, et delectus quo qui eveniet pariatur assumenda?</p>
                        </CardContent>
                        <CardFooter className='flex p-4'>
                            <Button>Continue Course</Button>
                        </CardFooter>
                        <div className='p-6'>
                            <h2 className='text-xl font-bold text-gray-700 mb-4'>Educator</h2>
                            <div className='flex items-center space-x-4'> 
                                <img src={selectedCourse?.creator?.photoUrl} alt="Educator" className='w-16 h-16 rounded-full' />
                                <div>
                                    <h3 className='text-lg font-bold text-gray-700'>{selectedCourse.creator.name}</h3>
